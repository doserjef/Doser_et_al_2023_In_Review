# main-joint-svc-interaction.R: script to fit a joint SVC model that 
#                               also contains an interaction between max
#                               temperature and grassland cover for the 
...
X.0$interaction <- X.0$grass * X.0$tmax
X.0 <- as.matrix(X.0)
...
save(auc.vals, file = 'results/joint-svc-interaction/auc-hold-out-samples.rda')
