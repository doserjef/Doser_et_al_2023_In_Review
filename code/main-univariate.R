# main-univariate.R: script to fit a single-species spatial occupancy model
#                    for use in the predictive performance assessment.
...
# Save to hard drive ------------------------------------------------------
save(out, file = paste('results/univariate-constant/', curr.sp, '-univariate-constant-results.rda', 
		       sep = ''))
